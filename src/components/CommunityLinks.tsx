...
const communityLinks = [
  {
    ...
    url: 'https://github.com/purewhitescreen/purewhitescreen',
  ...
  },
  {
    ...
    url: 'https://discord.gg/purewhitescreen',
  ...
  },
  {
    ...
    url: 'https://www.producthunt.com/products/purewhitescreen',
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-[oklch(0.7_0.02_0)]">
            Connect with creators, developers, and designers using Pure White Screen
          </p>
        </motion.div>
