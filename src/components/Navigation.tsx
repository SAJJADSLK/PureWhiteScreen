    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-[oklch(0.08_0.02_270)] to-[oklch(0.08_0.02_270)_/_0] backdrop-blur-md border-b border-[oklch(0.2_0.02_270)]">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663675331096/XLYmySE9WstZh2sm59wrFw/pure-white-screen-logo-AtVArfW3QPpAr4X5FDFdzF.webp" alt="Pure White Screen" className="w-8 h-8" />
          <span className="font-bold text-lg text-white hidden sm:inline">Pure White Screen</span>
        </Link>
