...
export default function BlackScreen() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-white/10 backdrop-blur-md rounded-full px-6 py-4 flex items-center gap-6 border border-white/20">
          {/* Brightness Control */}
      ...
      >
        <h1 className="text-4xl font-bold text-white/20">Black Screen</h1>
        <p className="text-white/10 mt-2">Press F for fullscreen • Move mouse to show controls</p>
      </motion.div>
    </div>
  );
}
