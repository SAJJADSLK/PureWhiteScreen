...
const testimonials: Testimonial[] = [
  {
    ...
    avatar: '👨‍💻',
    quote: 'ScreenLab transformed my streaming setup. The ring light simulator alone saves me hours of setup time. I use it every single day.',
    rating: 5,
  },
  {
    name: 'Sarah Johnson',
...
const metrics = [
  ...
  { icon: Clock, label: 'Hours Saved', value: '500K+', color: 'from-purple-500 to-pink-500' },
  { icon: TrendingUp, label: 'Screens Optimized', value: '100K+', color: 'from-green-500 to-emerald-500' },
    ...
    <section className="relative py-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <span className="text-lg">⭐</span>
            <span className="text-sm text-white">Product Hunt Featured</span>
          </motion.div>
          <motion.div
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm"
            variants={itemVariants}
          >
            <span className="text-lg">✅</span>
            <span className="text-sm text-white">GDPR Compliant</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
